...
class acoust_out(gr.top_block):
    ...
    def __init__(self, setfd, setcar):
        ...
        self.blocks_file_descriptor_source_0 = blocks.file_descriptor_source(gr.sizeof_char*1, fd, True)
        ...
        self.connect((self.blocks_file_descriptor_source_0, 0), (self.blks2_packet_encoder_0, 0))
